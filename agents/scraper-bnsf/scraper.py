...
Uses Crawl4AI with headless Chromium to scrape BNSF's official news library.
Source: https://www.bnsf.com/news-media/news-releases/library.page
"""
...
SOURCE_URL  = "https://www.bnsf.com/news-media/news-releases/library.page"
...
AI_TECH_KEYWORDS = [
    ...
    "safety technology", "efficiency", "software",
    "barstow", "logistics technology", "moderniz", "capital investment"
]
...
async def fetch_articles():
    ...
    for link in internal_links:
        ...
        if "news-release" not in href and "newsrelease" not in href:
            continue
        if len(title) < 25:
            continue
        ...
        url = href if href.startswith("http") else "https://www.bnsf.com" + href
